...
class Projects extends Component {
  render() {
    return (
      ...
      <Carousel
        ...
        <Card>
          ...
          <Button className="buttons" variant="outline-success" size="lg"><a href="https://github.com/lr001dev/reactStripeDashboardClient" target="_blank">Check Out The Front End Code</a></Button>
          </Card.Footer>
        </Card>
        </div>
        <div>
    ...
    <Card>
      ...
      <Card.Footer>
      <Button className="buttons" variant="outline-success" size="lg"><a href="https://chat-party.herokuapp.com" target="_blank">Live Demo</a></Button>
      <Button className="buttons" variant="outline-success" size="lg"><a href="https://lr001dev.github.io/Food-And-Fortune-WebApp/" target="_blank">Check Out The Code</a></Button>
      </Card.Footer>
    </Card>
        </div>
        <div>
